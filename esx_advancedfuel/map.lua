...
Config.ZoneSize     = {x = 8.0, y = 8.0, z = 5.0}
...
local blips = {
   ...
   {name=blipNameFuelBoat,id=427,x=1326.863,y=4218.219,z=33.55},
    {name=blipNameFuelBoat, id=427, x=3867.525,y=4470.780,z=2.500},	
    --------- AVIONS ---------
...
station = {
	...
	{x=3867.525,y=-4470.750,z=-0.399,s=1},
...
boat_stations = {
    ...
    {x=1322.839,y=4221.219,z=31.05,s=28},
		{x=3867.525,y=4470.780,z=2.500,s=28},
}
